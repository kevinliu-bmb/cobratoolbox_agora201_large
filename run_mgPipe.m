...
[init, netSecretionFluxes, netUptakeFluxes, Y, modelStats, summary] = initMgPipe(panPath, abunFilePath, computeProfiles, 'dietFilePath', dietFilePath, 'infoFilePath', infoFilePath, 'numWorkers', numWorkers);
%%
%% Computed outputs
%% 
